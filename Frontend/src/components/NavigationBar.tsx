  ...
  return (
    <nav className="fixed top-0 w-[100%] shadow-sm flex items-center px-10 justify-between bg-neutral">
      ...
      <ul className="flex  justify-center gap-x-5 font-bold  text-[20px] text-white my-5">
        <li className="hover:text-secondary duration-100 cursor-pointer">Home</li>
        <li className="hover:text-secondary duration-100 cursor-pointer">Add Product</li>
        <li className="hover:text-secondary duration-100 cursor-pointer">Categories</li>
      </ul>
